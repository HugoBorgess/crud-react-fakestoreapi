...
export default function Detalhes() {
  ...
  return (
    <section>
      <div className={stylesBase.voltar}>
        <h2
          className={stylesBase.voltar__texto}
          onClick={() => navigate(-1)}
        >
          {'< Voltar'}
        </h2>
        <button
          ...
          id='cadastrar'
          name='cadastrar'
          className={stylesBase.voltar__botao__salvar}
        ...
        <button
          ...
          className={stylesBase.voltar__botao__excluir}
